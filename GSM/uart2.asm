...
_Uart2_GetChar:
;uart2.c,34 :: 		uint8_t Uart2_GetChar()
;uart2.c,37 :: 		while ( ( UART2_S1 & UART_S1_RDRF_MASK) == 0 );     /* Wait for received buffer to be full*/
L_Uart2_GetChar2:
...
;uart2.c,53 :: 		void WriteUART2_dec2string(uint16_t dec)
...
;uart2.c,57 :: 		temp=dec/10000;
MOVW	R1, #10000
UDIV	R1, R3, R1
; temp start address is: 0 (R0)
UXTB	R0, R1
;uart2.c,58 :: 		if(temp>0)
UXTB	R1, R1
CMP	R1, #0
IT	LS
BLS	L_WriteUART2_dec2string6
;uart2.c,59 :: 		Uart2_SendChar(temp+'0');
ADDW	R1, R0, #48
STRB	R0, [SP, #4]
UXTB	R0, R1
BL	_Uart2_SendChar+0
...
UXTH	R2, R2
UXTH	R3, R2
;uart2.c,61 :: 		temp=dec/1000;
MOVW	R1, #1000
UDIV	R1, R2, R1
; temp start address is: 0 (R0)
UXTB	R0, R1
;uart2.c,62 :: 		if(temp>0)
UXTB	R1, R1
CMP	R1, #0
IT	LS
BLS	L_WriteUART2_dec2string7
;uart2.c,63 :: 		Uart2_SendChar(temp+'0');
ADDW	R1, R0, #48
STRB	R0, [SP, #4]
UXTB	R0, R1
BL	_Uart2_SendChar+0
...
UXTH	R2, R2
UXTH	R3, R2
;uart2.c,65 :: 		temp=dec/100;
MOVS	R1, #100
UDIV	R1, R2, R1
; temp start address is: 0 (R0)
UXTB	R0, R1
;uart2.c,66 :: 		if(temp>0)
UXTB	R1, R1
CMP	R1, #0
IT	LS
BLS	L_WriteUART2_dec2string8
;uart2.c,67 :: 		Uart2_SendChar(temp+'0');
ADDW	R1, R0, #48
STRB	R0, [SP, #4]
UXTB	R0, R1
BL	_Uart2_SendChar+0
...
;uart2.c,73 :: 		Uart2_SendChar(dec+'0');
ADDS	R1, #48
UXTB	R0, R1
BL	_Uart2_SendChar+0
;uart2.c,74 :: 		Uart2_SendChar('\r');
MOVS	R0, #13
BL	_Uart2_SendChar+0
;uart2.c,75 :: 		}
